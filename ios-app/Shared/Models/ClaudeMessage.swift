"""
ClaudeMessage.swift - Core data models for Claude Code mobile client.
...
struct StreamingChunk: Identifiable, Codable {
    ...
    init(content: String, chunkType: StreamingChunkType = .delta, messageId: String? = nil, timestamp: Date = Date()) {
        self.content = content
